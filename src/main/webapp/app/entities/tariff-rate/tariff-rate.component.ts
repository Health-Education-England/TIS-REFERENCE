...
@Component({
	selector: 'jhi-tariff-rate',
	templateUrl: './tariff-rate.component.html'
})
export class TariffRateComponent implements OnInit, OnDestroy {
	...
	transition() {
		this.router.navigate(['/tariff-rate'], {
			queryParams: {
				page: this.page,
				size: this.itemsPerPage,
	...
	trackId(index: number, item: TariffRate) {
		return item.id;
	}
