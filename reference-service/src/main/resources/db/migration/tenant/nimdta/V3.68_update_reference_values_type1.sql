...
VALUES 	(13,'Non-Binary','Non-Binary','CURRENT','a9601ee4-f0d1-11ed-9eb2-0638a616fc76'),
		(14,'Other (not listed)','Other (not listed)','CURRENT','b72fb5a6-f0d1-11ed-9eb2-0638a616fc76'),
		(15,'Not Stated','Not Stated','CURRENT','bdcf46fb-f0d1-11ed-9eb2-0638a616fc76');
#-----------------------------------------------------------------------

#2 - ETHNIC ORIGIN
INSERT INTO `reference nimdta`.ethnicorigin (code, status, uuid)
VALUES	('114','White - Any other White background','CURRENT','e13b46e7-f0d1-11ed-9eb2-0638a616fc76'),
		('115','Mixed - White and Black Caribbean','CURRENT','ef0e99fc-f0d1-11ed-9eb2-0638a616fc76'),
		('116','Mixed - White and Black African','CURRENT','f5572db6-f0d1-11ed-9eb2-0638a616fc76'),
		('117','Mixed - White and Asian','CURRENT','fc32c0c6-f0d1-11ed-9eb2-0638a616fc76'),
		('118','Mixed - Any other mixed background','CURRENT','011118b8-f0d2-11ed-9eb2-0638a616fc76'),
		('119','Asian or Asian British - Any other Asian background','CURRENT','07cd8151-f0d2-11ed-9eb2-0638a616fc76'),
		('120','Black or Black British - Any other Black background','CURRENT','0cc94e7f-f0d2-11ed-9eb2-0638a616fc76'),
		('121','Other Ethnic Groups - Chinese','CURRENT','131c7673-f0d2-11ed-9eb2-0638a616fc76'),
		('122','Other Ethnic Groups - Any other ethnic group','CURRENT','1a06d430-f0d2-11ed-9eb2-0638a616fc76');
        
UPDATE `reference nimdta`.ethnicorigin t1
SET t1.status = 'INACTIVE'
WHERE	t1.id IN (86, 87, 88, 89, 93, 96, 98);
#-----------------------------------------------------------------------
...
VALUES	(8,'Agnostic','Agnostic','CURRENT','0f8d7be9-3efb-11'),
...
SET t1.status = 'INACTIVE'
WHERE	t1.id IN (141, 143, 146, 149, 150);
#-----------------------------------------------------------------------
 
#4 - NATIONALITY
INSERT IGNORE INTO `reference nimdta`.nationality (id, countryNumber, nationality, status, uuid)
VALUES	(299,'Republic of Botswana','Batswana','CURRENT','43f29aee-a365-11'),
...
VALUES	(434,'Heterosexual or Straight','Heterosexual or Straight','CURRENT','33e9fddd-f0d2-11ed-9eb2-0638a616fc76'),
...
UPDATE `reference nimdta`.sexualorientation t1
SET t1.status = 'INACTIVE'
WHERE	t1.id IN (2,414,424);
#-----------------------------------------------------------------------

#6 - MARITAL STATUS
INSERT IGNORE INTO `reference nimdta`.maritalstatus (id, code, label, status, uuid)
VALUES	(20,'Married/Civil Partner','Married/Civil Partner','CURRENT','708687ce-f0d2-11ed-9eb2-0638a616fc76'),
...
UPDATE `reference nimdta`.maritalstatus t1
SET t1.status = 'INACTIVE'
WHERE	t1.id IN (2,3,8,12);
#-----------------------------------------------------------------------
