INSERT INTO `PermitToWork`(`code`, `label`, `status`, `uuid`)
VALUES
  ('UK/Irish National', 'UK/Irish National', 'CURRENT', 'c2a9fe40-7dc5-11eb-9f9a-0638a616fc76'),
  ('Dependant/Spouse visa', 'Dependant/Spouse visa', 'CURRENT', 'c2aa0317-7dc5-11eb-9f9a-0638a616fc76'),
  ('EU EEA National (started prior to June 2021)', 'EU EEA National (started prior to June 2021)', 'CURRENT', 'c2aa046e-7dc5-11eb-9f9a-0638a616fc76'),
  ('Spouse of EEA National (started prior to June 2021)', 'Spouse of EEA National (started prior to June 2021)', 'CURRENT', 'c2aa0569-7dc5-11eb-9f9a-0638a616fc76'),
  ('EU settlement scheme', 'EU settlement scheme', 'CURRENT', 'c2aa0652-7dc5-11eb-9f9a-0638a616fc76'),
  ('EU pre-settled status', 'EU pre-settled status', 'CURRENT', 'c2aa07d2-7dc5-11eb-9f9a-0638a616fc76'),
