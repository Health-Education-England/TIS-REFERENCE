...
public class EthnicOriginServiceImpl {
  ...
  public Page<EthnicOrigin> advancedSearch(String searchString, List<ColumnFilter> columnFilters, Pageable pageable) {
    ...
    if (!specs.isEmpty()) {
      Specifications<EthnicOrigin> fullSpec = Specifications.where(specs.get(0));
