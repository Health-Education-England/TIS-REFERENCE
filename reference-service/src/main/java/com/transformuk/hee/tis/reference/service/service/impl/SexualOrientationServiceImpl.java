...
public class SexualOrientationServiceImpl {
  ...
  public Page<SexualOrientation> advancedSearch(String searchString, List<ColumnFilter> columnFilters, Pageable pageable) {
    ...
    if (!specs.isEmpty()) {
      Specifications<SexualOrientation> fullSpec = Specifications.where(specs.get(0));
