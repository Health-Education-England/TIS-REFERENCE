...
public interface QualificationTypeMapper {
  ...
  List<QualificationTypeDTO> qualificationTypesToQualificationTypeDTOs(
      List<QualificationType> qualificationTypes);

  QualificationType qualificationTypeDTOToQualificationType(
      QualificationTypeDTO qualificationTypeDTO);

  List<QualificationType> qualificationTypeDTOsToQualificationTypes(
      List<QualificationTypeDTO> qualificationTypeDTOs);
}
