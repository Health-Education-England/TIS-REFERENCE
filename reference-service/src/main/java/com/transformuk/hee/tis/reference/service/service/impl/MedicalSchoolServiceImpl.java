...
public class MedicalSchoolServiceImpl {
  ...
  public Page<MedicalSchool> advancedSearch(String searchString, List<ColumnFilter> columnFilters, Pageable pageable) {
    ...
    if (!specs.isEmpty()) {
      Specifications<MedicalSchool> fullSpec = Specifications.where(specs.get(0));
