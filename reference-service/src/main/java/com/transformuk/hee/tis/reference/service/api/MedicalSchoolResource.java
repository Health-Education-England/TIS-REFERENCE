...
public class MedicalSchoolResource {
  ...
  public MedicalSchoolResource(MedicalSchoolRepository medicalSchoolRepository,
      MedicalSchoolMapper medicalSchoolMapper,
   ...
   * @return the ResponseEntity with status 201 (Created) and with body the new medicalSchoolDTO, or
   * with status 400 (Bad Request) if the medicalSchool has already an ID
    ...
    if (medicalSchoolDTO.getId() != null) {
      return ResponseEntity.badRequest().headers(HeaderUtil
          .createFailureAlert(ENTITY_NAME, "idexists",
              "A new medicalSchool cannot already have an ID")).body(null);
    }
    MedicalSchool medicalSchool = medicalSchoolMapper
        .medicalSchoolDTOToMedicalSchool(medicalSchoolDTO);
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the updated medicalSchoolDTO, or
   * with status 400 (Bad Request) if the medicalSchoolDTO is not valid, or with status 500
   * (Internal Server Error) if the medicalSchoolDTO couldnt be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
  ...
  public ResponseEntity<MedicalSchoolDTO> updateMedicalSchool(
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, medicalSchoolDTO.getId().toString()))
        .body(result);
  }
  ...
  public ResponseEntity<List<MedicalSchoolDTO>> getAllMedicalSchools(
    ...
    HttpHeaders headers = PaginationUtil
        .generatePaginationHttpHeaders(page, "/api/medical-schools");
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the medicalSchoolDTO, or with
   ...
   * @return the ResponseEntity with status 200 (Created) and with body the new medicalSchoolDTOS,
   * or with status 400 (Bad Request) if the MedicalSchoolDTO has already an ID
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
      ...
      if (!Collections.isEmpty(entityIds)) {
        return ResponseEntity.badRequest().headers(HeaderUtil
            .createFailureAlert(StringUtils.join(entityIds, ","), "ids.exist",
                "A new medicalSchools cannot already have an ID")).body(null);
      }
    }
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the updated medicalSchoolDTOS, or
   * with status 400 (Bad Request) if the medicalSchoolDTOS is not valid, or with status 500
   * (Internal Server Error) if the medicalSchoolDTOS couldnt be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
  ...
  public ResponseEntity<List<MedicalSchoolDTO>> bulkUpdateMedicalSchool(
    ...
    if (Collections.isEmpty(medicalSchoolDTOS)) {
      ...
      List<MedicalSchoolDTO> entitiesWithNoId = medicalSchoolDTOS.stream()
          .filter(medicalSchoolDTO -> medicalSchoolDTO.getId() == null)
          .collect(Collectors.toList());
