...
public class InactiveReasonResource {
  ...
  public InactiveReasonResource(InactiveReasonRepository inactiveReasonRepository,
      InactiveReasonMapper inactiveReasonMapper,
   ...
   * @return the ResponseEntity with status 201 (Created) and with body the new inactiveReasonDTO,
   * or with status 400 (Bad Request) if the inactiveReason has already an ID
    ...
    if (inactiveReasonDTO.getId() != null) {
      return ResponseEntity.badRequest().headers(HeaderUtil
          .createFailureAlert(ENTITY_NAME, "idexists",
              "A new inactiveReason cannot already have an ID")).body(null);
    }
    InactiveReason inactiveReason = inactiveReasonMapper
        .inactiveReasonDTOToInactiveReason(inactiveReasonDTO);
    inactiveReason = inactiveReasonRepository.save(inactiveReason);
    InactiveReasonDTO result = inactiveReasonMapper
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the updated inactiveReasonDTO, or
   * with status 400 (Bad Request) if the inactiveReasonDTO is not valid, or with status 500
   * (Internal Server Error) if the inactiveReasonDTO couldnt be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
  ...
  public ResponseEntity<InactiveReasonDTO> updateInactiveReason(
    ...
    return ResponseEntity.ok()
        .headers(
            HeaderUtil.createEntityUpdateAlert(ENTITY_NAME, inactiveReasonDTO.getId().toString()))
        .body(result);
  }
  ...
  public ResponseEntity<List<InactiveReasonDTO>> getAllInactiveReasons(
    ...
    Page<InactiveReasonDTO> results = page
        .map(inactiveReasonMapper::inactiveReasonToInactiveReasonDTO);
    HttpHeaders headers = PaginationUtil
        .generatePaginationHttpHeaders(page, "/api/inactive-reasons");
   ...
   * @return the ResponseEntity with status 200 (OK) and with body the inactiveReasonDTO, or with
   ...
   * @return the ResponseEntity with status 200 (Created) and with body the new inactiveReasonDTOS,
   * or with status 400 (Bad Request) if the InactiveReasonDTO has already an ID
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
      ...
      if (!Collections.isEmpty(entityIds)) {
        return ResponseEntity.badRequest().headers(HeaderUtil
            .createFailureAlert(StringUtils.join(entityIds, ","), "ids.exist",
                "A new inactiveReasons cannot already have an ID")).body(null);
      }
    }
   ...
   * or with status 400 (Bad Request) if the inactiveReasonDTOS is not valid, or with status 500
   * (Internal Server Error) if the inactiveReasonDTOS couldnt be updated
   * @throws URISyntaxException if the Location URI syntax is incorrect
   */
  ...
  public ResponseEntity<List<InactiveReasonDTO>> bulkUpdateInactiveReason(
    ...
    if (Collections.isEmpty(inactiveReasonDTOS)) {
      ...
      List<InactiveReasonDTO> entitiesWithNoId = inactiveReasonDTOS.stream()
          .filter(inactiveReasonDTO -> inactiveReasonDTO.getId() == null)
          .collect(Collectors.toList());
