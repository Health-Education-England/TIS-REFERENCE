...
public class GenderServiceImpl {
  ...
  public Page<Gender> advancedSearch(String searchString, List<ColumnFilter> columnFilters, Pageable pageable) {
    ...
    Page<Gender> result;
    if (!specs.isEmpty()) {
      Specifications<Gender> fullSpec = Specifications.where(specs.get(0));
