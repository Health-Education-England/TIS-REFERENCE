...
public class QualificationReferenceServiceImpl {
  ...
  public Page<QualificationReference> advancedSearch(String searchString, List<ColumnFilter> columnFilters, Pageable pageable) {
    ...
    if (!specs.isEmpty()) {
      Specifications<QualificationReference> fullSpec = Specifications.where(specs.get(0));
