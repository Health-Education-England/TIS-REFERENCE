...
public class GradeServiceImpl {
  ...
  public Page<Grade> advancedSearch(String searchString, List<ColumnFilter> columnFilters, Pageable pageable) {
    ...
    Page<Grade> result;
    if (!specs.isEmpty()) {
      Specifications<Grade> fullSpec = Specifications.where(specs.get(0));
